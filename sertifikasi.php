...
<body class="d-flex flex-column min-vh-100">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container-fluid">
		  ...
		  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item">
					<a class="nav-link active" aria-current="page" href="sertifikasi">Sertifikasi</a>
				</li>
				<li class="nav-item">
	...
	<div class="container-fluid">
		...
		<div class="row">
            ...
            <div class="col-9">
                <div class="card">
                    <div class="card-header" id="profilsingkat">Sertifikasi Kompetensi Bidang TIK</div>
                    <div class="card-body">
                        <p>Sertifikasi Kompetensi Kerja (selanjutnya disebut Sertifikasi Kompetensi) bidang Teknologi Informasi dan Komunikasi (TIK) di BPPTIK diselenggarakan pasca Pelatihan. Kegiatan Pelatihan dan Sertifikasi dapat dilihat di SIPS BPPTIK <a href="http://202.89.117.140/" target="_blank"> (klik di sini).</a> </p>
                    </div>
                </div>
            </div>
        </div>
